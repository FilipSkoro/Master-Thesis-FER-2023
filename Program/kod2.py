...
# train colors
COLOR = [(255, 0, 0, 255), (0, 255, 0, 255), (0, 0, 255, 255), (255, 215, 0, 255), (0, 255, 255, 255),
         (255, 165, 0, 255),(160, 32, 240, 255), (190, 190, 190, 255), (238, 130, 238, 255), (255, 255, 0, 255)]
...
def create_stops(pygame_screen, position, root, check, two_lane):
    ...
    if check == False:
        ...
        stop_height = 30
        # create stop object
        stop = Stop_class.Stop(pygame_screen, stop_color, stop_width, stop_height, position, root, stop_num, two_lane)
        stop_num = stop_num + 1
